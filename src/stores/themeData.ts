export const THEMES: Record<string, Record<string, string>> = {
  ...
  newspaper: {
    "--color-bg-primary": "#ede8de",
    "--color-bg-secondary": "#e5dfd4",
    "--color-bg-sidebar": "#e5dfd4",
    "--color-bg-hover": "#ddd6ca",
    "--color-bg-hover-blue": "#dad3c7",
    "--color-bg-active": "#d1c9bc",
    "--color-bg-elevated": "#ede8de",
    "--color-bg-frosted": "rgba(237, 232, 222, 0.95)",
